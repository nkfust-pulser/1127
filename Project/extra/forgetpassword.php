...
<head>
  ...
  <!-- Custom CSS -->
  <link href="css/forgetpassword-css.css" rel="stylesheet">
            ...
            <div class="col-md-4 col-md-offset-4">
              <div class="form-body">
                <ul class="nav nav-tabs final-login">
                  <li class="active"><a data-toggle="tab" href="#sectionA" style="text-align: center;font-size:18px;">找到你的帳號</a></li>
                </ul>
                <div class="tab-content">
                  <div id="sectionA" class="tab-pane fade in active">
                    <div class="innter-form">
                      <form class="sa-innate-form" method="post">
                        <input type="text" name="username" placeholder="請輸入你的信箱或帳號">
                        <p>請輸入你的信箱或者使用者帳號，我們將會傳證給你作驗證</p>
                        <div>
                        <input type="text" name="username" placeholder="收件電話">
                        <input type="text" name="username" placeholder="收件信箱">
                        </div>
                        <div class="buttonOKandForgetP">
                          <button type="button" class="btn btn-primary">傳送驗證</button>
                          <a href="resetpassword.php"><button type="button" class="btn btn-danger">重設密碼</button></a>
                        </div>
                      </form>
                    </div>
