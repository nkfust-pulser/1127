            ...
            <div class="col-md-4 col-md-offset-4">
              <div class="form-body">
                <ul class="nav nav-tabs">
                  <li class="active"><a data-toggle="tab" href="#sectionA" style="text-align: center;font-size:18px;">登入</a></li>
                </ul>
                <div class="tab-content">
                  <div id="sectionA" class="tab-pane fade in active">
                    <div class="innter-form">
                      <form class="sa-innate-form" method="post">
                        <input  name="username" type="text" placeholder="請輸入信箱">
                        ...
                        <input type="hidden" name="refer" value="<?php echo (isset($_GET['refer'])) ? $_GET['refer'] : 'login.php'; ?>">
                          <button type="submit" class="btn submitButton">確定</button>
